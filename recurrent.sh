...
#cat $DIR/../../_results/subs.new >> $DIR/../../_results/subs.old
#cat $DIR/../../_results/ports.new >> $DIR/../../_results/ports.old
#rm $DIR/../../_results/subs.new
#rm $DIR/../../_results/ports.new
...
### Display new ports ### 
echo "New ports: " >> $DIR/../../_results/ports.new
